          ...
          <div className='relative h-full w-full min-h-[37.5rem] flex items-center'>
            ...
            <div className='relative z-10 w-full pl-32 pr-20'>
              ...
              <div className='mt-4 flex'>
                ...
                <button
                  type='button'
                  className='bg-white border focus:outline-none focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 bg-zinc-800/40 text-white border-zinc-600 hover:bg-zinc-700 hover:border-zinc-600 focus:ring-zinc-700'
                >
                  Trailer
                </button>
              </div>
